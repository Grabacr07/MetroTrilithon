...
namespace MetroTrilithon.CodeAnalysis;
...
public sealed class AssemblyInfoSourceGenerator : IIncrementalGenerator
{
    ...
    private static class SourceEmitter
    {
        public static string Emit(AssemblyData data, string rootNamespace)
        {
            ...
            sb.AppendLine("    {");
            sb.AppendLine($"        public static global::MetroTrilithon.Properties.IAssemblyInfo Info {{ get; }} = new global::{propertiesNamespace}.AssemblyInfo();");
            sb.AppendLine("    }");
            ...
            sb.AppendLine("{");
            sb.AppendLine("    internal sealed class AssemblyInfo : global::MetroTrilithon.Properties.IAssemblyInfo");
            sb.AppendLine("    {");
