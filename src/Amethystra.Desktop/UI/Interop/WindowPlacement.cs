...
public class WindowPlacement(WindowState state, Rect rect)
{
    ...
    public void Apply(Window window)
    {
        ...
        var placement = new WINDOWPLACEMENT()
        {
            ...
            {
                WindowState.Minimized or WindowState.Maximized => SHOW_WINDOW_CMD.SW_MAXIMIZE,
