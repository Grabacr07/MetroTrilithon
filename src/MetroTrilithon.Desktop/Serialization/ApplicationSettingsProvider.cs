...
{
    public static ISerializationProvider Default { get; }
        = new ApplicationSettingsProvider(typeof(ApplicationSettingsProvider).FullName + "." + nameof(Default));
    ...
    public ApplicationSettingsProvider(string settingsKey)
        : base(settingsKey)
    {
    }
